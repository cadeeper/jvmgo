...
func newConstantInfo(tag uint8, cp ConstantPool) ConstantInfo {
	...
	case CONSTANT_Fieldref : return &ConstantFieldrefInfo{cp : cp}
	case CONSTANT_Methodref : return &ConstantMethodrefInfo{cp : cp}
	case CONSTANT_InterfaceMethodref : return &ConstantInterfaceMethodrefInfo{cp : cp}
	case CONSTANT_NameAndType : return &ConstantNameAndTypeInfo{cp : cp}
	case CONSTANT_MethodType : return &ConstantMethodTypeInfo{cp : cp}
	case CONSTANT_MethodHandle : return &ConstantMethodHandleInfo{cp : cp}
	case CONSTANT_InvokeDynamic : return &ConstantInvokeDynamicInfo{cp : cp}
	default:
